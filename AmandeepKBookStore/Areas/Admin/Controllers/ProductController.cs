...

{
    ...
    public class ProductController : System.Web.Mvc.Controller
    {
        ...
        public IActionResult Upsert(ProductVM productVM)
        {
            ...
            return (IActionResult)View(productVM);
        }
        ...
        public IActionResult GetAll()
        {
            ...
            return (IActionResult)Json(new { data = allObj });
        }
        ...
        public IActionResult Delete(int id)
        {
            ...
            if (objFromDb == null)
            {
                return (IActionResult)Json((success: false, message: "Error while deleting"));
            }
            string webRootPath = _hostEnvironment.WebRootPath;
            ...
            _unitOfWork.Save();
            return (IActionResult)Json((success: true, message: "Delete Successful"));
        }
