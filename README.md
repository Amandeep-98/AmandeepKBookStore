...
Moreover, i Copy the ‘Data’ folder and paste to .DataAccess project (delete the original)
...
To prepare for the next part,I ‘build’ the application and confirm there are no errors.
